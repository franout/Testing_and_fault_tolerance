...
module b12 ( clock, reset, start, k, nloss, nl, speaker, test_si1, test_so1, 
  ...
  FLIP_FLOP_D_RESET_SCAN \count_reg[0]  ( .D(n956), .SI(\count[5] ), .SE(
        test_se), .CK(clock), .RESET(n683), .Q(snps_count[0]) );
  FLIP_FLOP_D_RESET_SCAN \num_reg[1]  ( .D(N220), .SI(num[0]), .SE(test_se), 
        .CK(clock), .RESET(n683), .Q(num[1]) );
  FLIP_FLOP_D_RESET_SCAN \count_reg[1]  ( .D(N220), .SI(snps_count[0]), .SE(
        test_se), .CK(clock), .RESET(n683), .Q(snps_count[1]) );
  FLIP_FLOP_D_RESET_SCAN \num_reg[0]  ( .D(n956), .SI(nloss), .SE(test_se), 
        .CK(clock), .RESET(n683), .Q(num[0]) );
  FLIP_FLOP_D_RESET_SCAN \gamma_reg[0]  ( .D(N911), .SI(data_out[1]), .SE(
        test_se), .CK(clock), .RESET(n683), .Q(gamma[0]) );
  FLIP_FLOP_D_RESET_SCAN \data_out_reg[1]  ( .D(N286), .SI(data_out[0]), .SE(
        test_se), .CK(clock), .RESET(n683), .Q(data_out[1]) );
  FLIP_FLOP_D_RESET_SCAN \gamma_reg[2]  ( .D(N913), .SI(gamma[1]), .SE(test_se), .CK(clock), .RESET(n683), .Q(gamma[2]) );
  FLIP_FLOP_D_RESET_SCAN \gamma_reg[1]  ( .D(N912), .SI(gamma[0]), .SE(test_se), .CK(clock), .RESET(n683), .Q(gamma[1]) );
  FLIP_FLOP_D_RESET_SCAN \gamma_reg[4]  ( .D(N915), .SI(gamma[3]), .SE(test_se), .CK(clock), .RESET(n683), .Q(gamma[4]) );
  FLIP_FLOP_D_RESET_SCAN \gamma_reg[3]  ( .D(N914), .SI(gamma[2]), .SE(test_se), .CK(clock), .RESET(n683), .Q(gamma[3]) );
  FLIP_FLOP_D_RESET_SCAN \data_out_reg[0]  ( .D(N287), .SI(data_in[1]), .SE(
        test_se), .CK(clock), .RESET(n683), .Q(data_out[0]) );
  FLIP_FLOP_D_RESET_SCAN \counter_reg[0]  ( .D(N213), .SI(snps_count[1]), .SE(
        test_se), .CK(clock), .RESET(n683), .Q(counter[0]) );
  FLIP_FLOP_D_RESET_SCAN \counter_reg[1]  ( .D(N214), .SI(counter[0]), .SE(
  ...
  FLIP_FLOP_D_RESET_SCAN \max_reg[0]  ( .D(n788), .SI(ind[1]), .SE(test_se), 
        .CK(clock), .RESET(n683), .Q(max[0]) );
  FLIP_FLOP_D_RESET_SCAN \max_reg[1]  ( .D(n787), .SI(max[0]), .SE(test_se), 
        .CK(clock), .RESET(n683), .Q(max[1]) );
  FLIP_FLOP_D_RESET_SCAN \max_reg[2]  ( .D(n786), .SI(max[1]), .SE(test_se), 
        .CK(clock), .RESET(n683), .Q(max[2]) );
  FLIP_FLOP_D_RESET_SCAN \max_reg[3]  ( .D(n785), .SI(max[2]), .SE(test_se), 
        .CK(clock), .RESET(n683), .Q(max[3]) );
  FLIP_FLOP_D_RESET_SCAN \timebase_reg[5]  ( .D(n784), .SI(timebase[4]), .SE(
        test_se), .CK(clock), .RESET(n683), .Q(timebase[5]) );
  FLIP_FLOP_D_RESET_SCAN \timebase_reg[0]  ( .D(n783), .SI(sound[2]), .SE(
        test_se), .CK(clock), .RESET(n683), .Q(timebase[0]) );
  FLIP_FLOP_D_RESET_SCAN \timebase_reg[1]  ( .D(n782), .SI(timebase[0]), .SE(
        test_se), .CK(clock), .RESET(n683), .Q(timebase[1]) );
  FLIP_FLOP_D_RESET_SCAN \timebase_reg[2]  ( .D(n781), .SI(timebase[1]), .SE(
        test_se), .CK(clock), .RESET(n683), .Q(timebase[2]) );
  FLIP_FLOP_D_RESET_SCAN \timebase_reg[3]  ( .D(n780), .SI(timebase[2]), .SE(
        test_se), .CK(clock), .RESET(n683), .Q(timebase[3]) );
  FLIP_FLOP_D_RESET_SCAN \timebase_reg[4]  ( .D(n779), .SI(timebase[3]), .SE(
        test_se), .CK(clock), .RESET(n683), .Q(timebase[4]) );
  FLIP_FLOP_D_RESET_SCAN \count_reg2[0]  ( .D(n778), .SI(address[4]), .SE(
        test_se), .CK(clock), .RESET(n683), .Q(\count[0]1 ) );
  FLIP_FLOP_D_RESET_SCAN \scan_reg[4]  ( .D(n777), .SI(scan[3]), .SE(test_se), 
        .CK(clock), .RESET(n683), .Q(scan[4]) );
  FLIP_FLOP_D_RESET_SCAN \scan_reg[0]  ( .D(n776), .SI(s), .SE(test_se), .CK(
        clock), .RESET(n683), .Q(scan[0]) );
  FLIP_FLOP_D_RESET_SCAN \scan_reg[1]  ( .D(n775), .SI(scan[0]), .SE(test_se), 
        .CK(clock), .RESET(n683), .Q(scan[1]) );
  FLIP_FLOP_D_RESET_SCAN \scan_reg[2]  ( .D(n774), .SI(scan[1]), .SE(test_se), 
        .CK(clock), .RESET(n683), .Q(scan[2]) );
  FLIP_FLOP_D_RESET_SCAN \scan_reg[3]  ( .D(n773), .SI(scan[2]), .SE(test_se), 
        .CK(clock), .RESET(n683), .Q(scan[3]) );
  FLIP_FLOP_D_RESET_SCAN \ind_reg[0]  ( .D(n772), .SI(gamma[4]), .SE(test_se), 
        .CK(clock), .RESET(n683), .Q(ind[0]) );
  FLIP_FLOP_D_RESET_SCAN \ind_reg[1]  ( .D(n771), .SI(ind[0]), .SE(test_se), 
        .CK(clock), .RESET(n683), .Q(ind[1]) );
  FLIP_FLOP_D_RESET_SCAN \address_reg[0]  ( .D(n770), .SI(test_si1), .SE(
        test_se), .CK(clock), .RESET(n683), .Q(address[0]) );
  FLIP_FLOP_D_RESET_SCAN \address_reg[1]  ( .D(n769), .SI(address[0]), .SE(
        test_se), .CK(clock), .RESET(n683), .Q(address[1]) );
  FLIP_FLOP_D_RESET_SCAN \address_reg[2]  ( .D(n768), .SI(address[1]), .SE(
        test_se), .CK(clock), .RESET(n683), .Q(address[2]) );
  FLIP_FLOP_D_RESET_SCAN \data_in_reg[0]  ( .D(n767), .SI(N162), .SE(test_se), 
        .CK(clock), .RESET(n683), .Q(data_in[0]) );
  FLIP_FLOP_D_RESET_SCAN \data_in_reg[1]  ( .D(n766), .SI(data_in[0]), .SE(
  ...
  FLIP_FLOP_D_RESET_SCAN \memory_reg[15][0]  ( .D(n764), .SI(\memory[14][1] ), 
        .SE(test_se), .CK(clock), .RESET(n683), .Q(\memory[15][0] ) );
  FLIP_FLOP_D_RESET_SCAN \memory_reg[15][1]  ( .D(n763), .SI(\memory[15][0] ), 
  ...
  FLIP_FLOP_D_RESET_SCAN \memory_reg[13][1]  ( .D(n759), .SI(\memory[13][0] ), 
        .SE(test_se), .CK(clock), .RESET(n683), .Q(\memory[13][1] ) );
  FLIP_FLOP_D_RESET_SCAN \memory_reg[12][0]  ( .D(n758), .SI(\memory[11][1] ), 
        .SE(test_se), .CK(clock), .RESET(n683), .Q(\memory[12][0] ) );
  FLIP_FLOP_D_RESET_SCAN \memory_reg[12][1]  ( .D(n757), .SI(\memory[12][0] ), 
        .SE(test_se), .CK(clock), .RESET(n683), .Q(\memory[12][1] ) );
  FLIP_FLOP_D_RESET_SCAN \memory_reg[11][0]  ( .D(n756), .SI(\memory[10][1] ), 
        .SE(test_se), .CK(clock), .RESET(n683), .Q(\memory[11][0] ) );
  FLIP_FLOP_D_RESET_SCAN \memory_reg[11][1]  ( .D(n755), .SI(\memory[11][0] ), 
        .SE(test_se), .CK(clock), .RESET(n683), .Q(\memory[11][1] ) );
  FLIP_FLOP_D_RESET_SCAN \memory_reg[10][0]  ( .D(n754), .SI(\memory[9][1] ), 
        .SE(test_se), .CK(clock), .RESET(n683), .Q(\memory[10][0] ) );
  FLIP_FLOP_D_RESET_SCAN \memory_reg[10][1]  ( .D(n753), .SI(\memory[10][0] ), 
        .SE(test_se), .CK(clock), .RESET(n683), .Q(\memory[10][1] ) );
  FLIP_FLOP_D_RESET_SCAN \memory_reg[9][0]  ( .D(n752), .SI(\memory[8][1] ), 
        .SE(test_se), .CK(clock), .RESET(n683), .Q(\memory[9][0] ) );
  FLIP_FLOP_D_RESET_SCAN \memory_reg[9][1]  ( .D(n751), .SI(\memory[9][0] ), 
        .SE(test_se), .CK(clock), .RESET(n683), .Q(\memory[9][1] ) );
  FLIP_FLOP_D_RESET_SCAN \memory_reg[8][0]  ( .D(n750), .SI(\memory[7][1] ), 
        .SE(test_se), .CK(clock), .RESET(n683), .Q(\memory[8][0] ) );
  FLIP_FLOP_D_RESET_SCAN \memory_reg[8][1]  ( .D(n749), .SI(\memory[8][0] ), 
        .SE(test_se), .CK(clock), .RESET(n683), .Q(\memory[8][1] ) );
  FLIP_FLOP_D_RESET_SCAN \sound_reg[2]  ( .D(n748), .SI(sound[1]), .SE(test_se), .CK(clock), .RESET(n683), .Q(sound[2]) );
  FLIP_FLOP_D_RESET_SCAN play_reg ( .D(n747), .SI(num[1]), .SE(test_se), .CK(
        clock), .RESET(n683), .Q(play) );
  FLIP_FLOP_D_RESET_SCAN \address_reg[3]  ( .D(n746), .SI(address[2]), .SE(
        test_se), .CK(clock), .RESET(n683), .Q(address[3]) );
  FLIP_FLOP_D_RESET_SCAN \memory_reg[31][0]  ( .D(n745), .SI(\memory[30][1] ), 
        .SE(test_se), .CK(clock), .RESET(n683), .Q(\memory[31][0] ) );
  FLIP_FLOP_D_RESET_SCAN \memory_reg[31][1]  ( .D(n744), .SI(\memory[31][0] ), 
        .SE(test_se), .CK(clock), .RESET(n683), .Q(\memory[31][1] ) );
  FLIP_FLOP_D_RESET_SCAN \memory_reg[30][0]  ( .D(n743), .SI(\memory[29][1] ), 
        .SE(test_se), .CK(clock), .RESET(n683), .Q(\memory[30][0] ) );
  FLIP_FLOP_D_RESET_SCAN \memory_reg[30][1]  ( .D(n742), .SI(\memory[30][0] ), 
  ...
  FLIP_FLOP_D_RESET_SCAN \memory_reg[28][1]  ( .D(n738), .SI(\memory[28][0] ), 
        .SE(test_se), .CK(clock), .RESET(n683), .Q(\memory[28][1] ) );
  FLIP_FLOP_D_RESET_SCAN \memory_reg[27][0]  ( .D(n737), .SI(\memory[26][1] ), 
        .SE(test_se), .CK(clock), .RESET(n683), .Q(\memory[27][0] ) );
  FLIP_FLOP_D_RESET_SCAN \memory_reg[27][1]  ( .D(n736), .SI(\memory[27][0] ), 
        .SE(test_se), .CK(clock), .RESET(n683), .Q(\memory[27][1] ) );
  FLIP_FLOP_D_RESET_SCAN \memory_reg[26][0]  ( .D(n735), .SI(\memory[25][1] ), 
        .SE(test_se), .CK(clock), .RESET(n683), .Q(\memory[26][0] ) );
  FLIP_FLOP_D_RESET_SCAN \memory_reg[26][1]  ( .D(n734), .SI(\memory[26][0] ), 
        .SE(test_se), .CK(clock), .RESET(n683), .Q(\memory[26][1] ) );
  FLIP_FLOP_D_RESET_SCAN \memory_reg[25][0]  ( .D(n733), .SI(\memory[24][1] ), 
        .SE(test_se), .CK(clock), .RESET(n683), .Q(\memory[25][0] ) );
  FLIP_FLOP_D_RESET_SCAN \memory_reg[25][1]  ( .D(n732), .SI(\memory[25][0] ), 
  ...
  FLIP_FLOP_D_RESET_SCAN \memory_reg[23][1]  ( .D(n728), .SI(\memory[23][0] ), 
        .SE(test_se), .CK(clock), .RESET(n683), .Q(\memory[23][1] ) );
  FLIP_FLOP_D_RESET_SCAN \memory_reg[22][0]  ( .D(n727), .SI(\memory[21][1] ), 
        .SE(test_se), .CK(clock), .RESET(n683), .Q(\memory[22][0] ) );
  FLIP_FLOP_D_RESET_SCAN \memory_reg[22][1]  ( .D(n726), .SI(\memory[22][0] ), 
        .SE(test_se), .CK(clock), .RESET(n683), .Q(\memory[22][1] ) );
  FLIP_FLOP_D_RESET_SCAN \memory_reg[21][0]  ( .D(n725), .SI(\memory[20][1] ), 
        .SE(test_se), .CK(clock), .RESET(n683), .Q(\memory[21][0] ) );
  FLIP_FLOP_D_RESET_SCAN \memory_reg[21][1]  ( .D(n724), .SI(\memory[21][0] ), 
        .SE(test_se), .CK(clock), .RESET(n683), .Q(\memory[21][1] ) );
  FLIP_FLOP_D_RESET_SCAN \memory_reg[20][0]  ( .D(n723), .SI(\memory[19][1] ), 
        .SE(test_se), .CK(clock), .RESET(n683), .Q(\memory[20][0] ) );
  FLIP_FLOP_D_RESET_SCAN \memory_reg[20][1]  ( .D(n722), .SI(\memory[20][0] ), 
        .SE(test_se), .CK(clock), .RESET(n683), .Q(\memory[20][1] ) );
  FLIP_FLOP_D_RESET_SCAN \memory_reg[19][0]  ( .D(n721), .SI(\memory[18][1] ), 
        .SE(test_se), .CK(clock), .RESET(n683), .Q(\memory[19][0] ) );
  FLIP_FLOP_D_RESET_SCAN \memory_reg[19][1]  ( .D(n720), .SI(\memory[19][0] ), 
        .SE(test_se), .CK(clock), .RESET(n683), .Q(\memory[19][1] ) );
  FLIP_FLOP_D_RESET_SCAN \memory_reg[18][0]  ( .D(n719), .SI(\memory[17][1] ), 
        .SE(test_se), .CK(clock), .RESET(n683), .Q(\memory[18][0] ) );
  FLIP_FLOP_D_RESET_SCAN \memory_reg[18][1]  ( .D(n718), .SI(\memory[18][0] ), 
        .SE(test_se), .CK(clock), .RESET(n683), .Q(\memory[18][1] ) );
  FLIP_FLOP_D_RESET_SCAN \memory_reg[17][0]  ( .D(n717), .SI(\memory[16][1] ), 
        .SE(test_se), .CK(clock), .RESET(n683), .Q(\memory[17][0] ) );
  FLIP_FLOP_D_RESET_SCAN \memory_reg[17][1]  ( .D(n716), .SI(\memory[17][0] ), 
        .SE(test_se), .CK(clock), .RESET(n683), .Q(\memory[17][1] ) );
  FLIP_FLOP_D_RESET_SCAN \memory_reg[16][0]  ( .D(n715), .SI(\memory[15][1] ), 
        .SE(test_se), .CK(clock), .RESET(n683), .Q(\memory[16][0] ) );
  FLIP_FLOP_D_RESET_SCAN \memory_reg[16][1]  ( .D(n714), .SI(\memory[16][0] ), 
        .SE(test_se), .CK(clock), .RESET(n683), .Q(\memory[16][1] ) );
  FLIP_FLOP_D_RESET_SCAN \memory_reg[7][0]  ( .D(n713), .SI(\memory[6][1] ), 
        .SE(test_se), .CK(clock), .RESET(n683), .Q(\memory[7][0] ) );
  FLIP_FLOP_D_RESET_SCAN \memory_reg[7][1]  ( .D(n712), .SI(\memory[7][0] ), 
        .SE(test_se), .CK(clock), .RESET(n683), .Q(\memory[7][1] ) );
  FLIP_FLOP_D_RESET_SCAN \memory_reg[6][0]  ( .D(n711), .SI(\memory[5][1] ), 
        .SE(test_se), .CK(clock), .RESET(n683), .Q(\memory[6][0] ) );
  FLIP_FLOP_D_RESET_SCAN \memory_reg[6][1]  ( .D(n710), .SI(\memory[6][0] ), 
        .SE(test_se), .CK(clock), .RESET(n683), .Q(\memory[6][1] ) );
  FLIP_FLOP_D_RESET_SCAN \memory_reg[5][0]  ( .D(n709), .SI(\memory[4][1] ), 
        .SE(test_se), .CK(clock), .RESET(n683), .Q(\memory[5][0] ) );
  FLIP_FLOP_D_RESET_SCAN \memory_reg[5][1]  ( .D(n708), .SI(\memory[5][0] ), 
  ...
  FLIP_FLOP_D_RESET_SCAN \memory_reg[3][1]  ( .D(n704), .SI(\memory[3][0] ), 
        .SE(test_se), .CK(clock), .RESET(n683), .Q(\memory[3][1] ) );
  FLIP_FLOP_D_RESET_SCAN \memory_reg[2][0]  ( .D(n703), .SI(\memory[1][1] ), 
        .SE(test_se), .CK(clock), .RESET(n683), .Q(\memory[2][0] ) );
  FLIP_FLOP_D_RESET_SCAN \memory_reg[2][1]  ( .D(n702), .SI(\memory[2][0] ), 
        .SE(test_se), .CK(clock), .RESET(n683), .Q(\memory[2][1] ) );
  FLIP_FLOP_D_RESET_SCAN \memory_reg[1][0]  ( .D(n701), .SI(\memory[0][1] ), 
        .SE(test_se), .CK(clock), .RESET(n683), .Q(\memory[1][0] ) );
  FLIP_FLOP_D_RESET_SCAN \memory_reg[1][1]  ( .D(n700), .SI(\memory[1][0] ), 
        .SE(test_se), .CK(clock), .RESET(n683), .Q(\memory[1][1] ) );
  FLIP_FLOP_D_RESET_SCAN \memory_reg[0][0]  ( .D(n699), .SI(max[4]), .SE(
        test_se), .CK(clock), .RESET(n683), .Q(\memory[0][0] ) );
  FLIP_FLOP_D_RESET_SCAN \memory_reg[0][1]  ( .D(n698), .SI(\memory[0][0] ), 
        .SE(test_se), .CK(clock), .RESET(n683), .Q(\memory[0][1] ) );
  FLIP_FLOP_D_RESET_SCAN \nl_reg[3]  ( .D(n697), .SI(nl[2]), .SE(test_se), 
        .CK(clock), .RESET(n683), .Q(nl[3]) );
  FLIP_FLOP_D_RESET_SCAN \nl_reg[2]  ( .D(n696), .SI(nl[1]), .SE(test_se), 
        .CK(clock), .RESET(n683), .Q(nl[2]) );
  FLIP_FLOP_D_RESET_SCAN \sound_reg[0]  ( .D(n695), .SI(scan[4]), .SE(test_se), 
        .CK(clock), .RESET(n683), .Q(sound[0]) );
  FLIP_FLOP_D_RESET_SCAN \count_reg2[3]  ( .D(n694), .SI(\count[2] ), .SE(
        test_se), .CK(clock), .RESET(n683), .Q(\count[3] ) );
  FLIP_FLOP_D_RESET_SCAN \count_reg2[1]  ( .D(n693), .SI(\count[0]1 ), .SE(
        test_se), .CK(clock), .RESET(n683), .Q(\count[1]1 ) );
  FLIP_FLOP_D_RESET_SCAN \count_reg2[2]  ( .D(n692), .SI(\count[1]1 ), .SE(
        test_se), .CK(clock), .RESET(n683), .Q(\count[2] ) );
  FLIP_FLOP_D_RESET_SCAN \count_reg2[4]  ( .D(n691), .SI(\count[3] ), .SE(
        test_se), .CK(clock), .RESET(n683), .Q(\count[4] ) );
  FLIP_FLOP_D_RESET_SCAN \count_reg2[5]  ( .D(n690), .SI(\count[4] ), .SE(
        test_se), .CK(clock), .RESET(n683), .Q(\count[5] ) );
  FLIP_FLOP_D_RESET_SCAN nloss_reg ( .D(n689), .SI(nl[3]), .SE(test_se), .CK(
        clock), .RESET(n683), .Q(nloss) );
  FLIP_FLOP_D_RESET_SCAN \nl_reg[0]  ( .D(n688), .SI(\memory[31][1] ), .SE(
        test_se), .CK(clock), .RESET(n683), .Q(nl[0]) );
  FLIP_FLOP_D_RESET_SCAN \nl_reg[1]  ( .D(n687), .SI(nl[0]), .SE(test_se), 
        .CK(clock), .RESET(n683), .Q(nl[1]) );
  FLIP_FLOP_D_RESET_SCAN \sound_reg[1]  ( .D(n686), .SI(sound[0]), .SE(test_se), .CK(clock), .RESET(n683), .Q(sound[1]) );
  FLIP_FLOP_D_RESET_SCAN s_reg ( .D(n685), .SI(play), .SE(test_se), .CK(clock), 
        .RESET(n683), .Q(s) );
  FLIP_FLOP_D_RESET_SCAN speaker_reg ( .D(n684), .SI(wr), .SE(test_se), .CK(
        clock), .RESET(n683), .Q(speaker) );
endmodule
