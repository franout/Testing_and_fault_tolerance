...
asm volatile ("pv.minu.sci.h %0,%1,%2": "=r" (c): "r" (b) , "i" (0x04));
res=c;
...
res=c;
asm volatile ("pv.maxu.sci.b %0,%1,%2": "=r" (c): "r" (b) , "i" (0x003));
res=c;
...
res=c;
asm volatile ("sltiu  %0,%1,%2": "=r" (c): "r" (a), "i" (421));
res=c;
...
res=c;
asm volatile("addi %0 , %1, %2": "=r" (c) : "r" (a) , "i" (999));
res=c;
