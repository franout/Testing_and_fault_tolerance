...
b=~pattern[i];
asm volatile ("pv.add.sci.b %0,%1,%2": "=r" (c): "r" (b) , "i" (0x0FF));
res=c;
b=pattern[i];
...
b=~pattern[i];
asm volatile ("pv.add.sci.h %0,%1,%2": "=r" (c): "r" (b) , "i" (0x0FF));
res=c;
b=pattern[i];
...
res=c;
b=~pattern[i];
asm volatile ("pv.sub.sci.b %0,%1,%2": "=r" (c): "r" (b) , "i" (0x0FF));
res=c;
b=pattern[i];
asm volatile ("pv.sub.sci.b %0,%1,%2": "=r" (c): "r" (b) , "i" (0x000));
res=c;
b=~pattern[i];
asm volatile ("pv.sub.sci.h %0,%1,%2": "=r" (c): "r" (b) , "i" (0x0FF));
res=c;
b=pattern[i];
...
res=c;
b=~pattern[i];
asm volatile ("pv.avg.sci.b %0,%1,%2": "=r" (c): "r" (b) , "i" (0x0FF));
res=c;
b=pattern[i];
asm volatile ("pv.avg.sci.b %0,%1,%2": "=r" (c): "r" (b) , "i" (0x000));
res=c;
b=~pattern[i];
asm volatile ("pv.avg.sci.h %0,%1,%2": "=r" (c): "r" (b) , "i" (0x0FF));
res=c;
b=pattern[i];
...
res=c;
b=~pattern[i];
asm volatile ("pv.avgu.sci.b %0,%1,%2": "=r" (c): "r" (b) , "i" (0x0FF));
res=c;
b=pattern[i];
asm volatile ("pv.avgu.sci.b %0,%1,%2": "=r" (c): "r" (b) , "i" (0x000));
res=c;
b=~pattern[i];
asm volatile ("pv.avgu.sci.h %0,%1,%2": "=r" (c): "r" (b) , "i" (0x0FF));
res=c;
b=pattern[i];
...
b=~pattern[i];
asm volatile ("pv.min.sci.b %0,%1,%2": "=r" (c): "r" (b) , "i" (0x0FF));
res=c;
b=pattern[i];
...
b=~pattern[i];
asm volatile ("pv.min.sci.h %0,%1,%2": "=r" (c): "r" (b) , "i" (0x0FF));
res=c;
b=pattern[i];
...
b=~pattern[i];
asm volatile ("pv.minu.sci.b %0,%1,%2": "=r" (c): "r" (b) , "i" (0x0FF));
res=c;
b=pattern[i];
...
b=~pattern[i];
asm volatile ("pv.minu.sci.h %0,%1,%2": "=r" (c): "r" (b) , "i" (0x0FF));
res=c;
b=pattern[i];
...
b=~pattern[i];
asm volatile ("pv.max.sci.b %0,%1,%2": "=r" (c): "r" (b) , "i" (0x0FF));
res=c;
b=pattern[i];
...
b=~pattern[i];
asm volatile ("pv.max.sci.h %0,%1,%2": "=r" (c): "r" (b) , "i" (0x0FF));
res=c;
b=pattern[i];
...
b=~pattern[i];
asm volatile ("pv.maxu.sci.b %0,%1,%2": "=r" (c): "r" (b) , "i" (0x0FF));
res=c;
b=pattern[i];
...
b=~pattern[i];
asm volatile ("pv.maxu.sci.h %0,%1,%2": "=r" (c): "r" (b) , "i" (0x0FF));
res=c;
b=pattern[i];
...
b=~pattern[i];
asm volatile ("pv.srl.sci.b %0,%1,%2": "=r" (c): "r" (b) , "i" (0x0FF));
res=c;
b=pattern[i];
...
b=~pattern[i];
asm volatile ("pv.srl.sci.h %0,%1,%2": "=r" (c): "r" (b) , "i" (0x0FF));
res=c;
b=pattern[i];
...
b=~pattern[i];
asm volatile ("pv.sra.sci.b %0,%1,%2": "=r" (c): "r" (b) , "i" (0x0FF));
res=c;
b=pattern[i];
...
b=~pattern[i];
asm volatile ("pv.sra.sci.h %0,%1,%2": "=r" (c): "r" (b) , "i" (0x0FF));
res=c;
b=pattern[i];
...
b=~pattern[i];
asm volatile ("pv.sll.sci.b %0,%1,%2": "=r" (c): "r" (b) , "i" (0x0FF));
res=c;
b=pattern[i];
...
b=~pattern[i];
asm volatile ("pv.sll.sci.h %0,%1,%2": "=r" (c): "r" (b) , "i" (0x0FF));
res=c;
b=pattern[i];
...
b=~pattern[i];
asm volatile ("pv.or.sci.b %0,%1,%2": "=r" (c): "r" (b) , "i" (0x0FF));
res=c;
b=pattern[i];
...
b=~pattern[i];
asm volatile ("pv.or.sci.h %0,%1,%2": "=r" (c): "r" (b) , "i" (0x0FF));
res=c;
b=pattern[i];
...
b=~pattern[i];
asm volatile ("pv.xor.sci.b %0,%1,%2": "=r" (c): "r" (b) , "i" (0x0FF));
res=c;
b=pattern[i];
...
b=~pattern[i];
asm volatile ("pv.xor.sci.h %0,%1,%2": "=r" (c): "r" (b) , "i" (0x0FF));
res=c;
b=pattern[i];
...
b=~pattern[i];
asm volatile ("pv.and.sci.b %0,%1,%2": "=r" (c): "r" (b) , "i" (0x0FF));
res=c;
b=pattern[i];
...
b=~pattern[i];
asm volatile ("pv.and.sci.h %0,%1,%2": "=r" (c): "r" (b) , "i" (0x0FF));
res=c;
b=pattern[i];
...
res=c;b=~pattern[i];
asm volatile("pv.cmpeq.sci.h %0,%1,%2": "=r" (c) : "r" (a) , "i" (0)  );
res=c;b=pattern[i];
asm volatile("pv.cmpeq.sci.h %0,%1,%2": "=r" (c) : "r" (b) , "i" (15)  );
res=c;b=~pattern[i];
asm volatile("pv.cmpeq.sci.b %0,%1,%2": "=r" (c) : "r" (a) , "i" (0)  );
res=c;b=pattern[i];
asm volatile("pv.cmpeq.sci.b %0,%1,%2": "=r" (c) : "r" (b) , "i" (15)  );
res=c;
...
res=c;b=~pattern[i];
asm volatile("pv.cmpne.sci.h %0,%1,%2": "=r" (c) : "r" (a) , "i" (0)  );
res=c;b=pattern[i];
asm volatile("pv.cmpne.sci.h %0,%1,%2": "=r" (c) : "r" (b) , "i" (15)  );
res=c;b=~pattern[i];
asm volatile("pv.cmpne.sci.b %0,%1,%2": "=r" (c) : "r" (a) , "i" (0)  );
res=c;b=pattern[i];
asm volatile("pv.cmpne.sci.b %0,%1,%2": "=r" (c) : "r" (b) , "i" (15)  );
res=c;
b=~pattern[i];
...
res=c;b=~pattern[i];
asm volatile("pv.cmpgt.sci.h %0,%1,%2": "=r" (c) : "r" (a) , "i" (0)  );
res=c;b=pattern[i];
asm volatile("pv.cmpgt.sci.h %0,%1,%2": "=r" (c) : "r" (b) , "i" (15)  );
res=c;b=~pattern[i];
asm volatile("pv.cmpgt.sci.b %0,%1,%2": "=r" (c) : "r" (a) , "i" (0)  );
res=c;b=pattern[i];
asm volatile("pv.cmpgt.sci.b %0,%1,%2": "=r" (c) : "r" (b) , "i" (15)  );
res=c;
b=~pattern[i];
...
res=c;b=~pattern[i];
asm volatile("pv.cmpge.sci.h %0,%1,%2": "=r" (c) : "r" (a) , "i" (0)  );
res=c;b=pattern[i];
asm volatile("pv.cmpge.sci.h %0,%1,%2": "=r" (c) : "r" (b) , "i" (15)  );
res=c;b=~pattern[i];
asm volatile("pv.cmpge.sci.b %0,%1,%2": "=r" (c) : "r" (a) , "i" (0)  );
res=c;b=pattern[i];
asm volatile("pv.cmpge.sci.b %0,%1,%2": "=r" (c) : "r" (b) , "i" (15)  );
res=c;
b=~pattern[i];
...
res=c;b=~pattern[i];
asm volatile("pv.cmplt.sci.h %0,%1,%2": "=r" (c) : "r" (a) , "i" (0)  );
res=c;b=pattern[i];
asm volatile("pv.cmplt.sci.h %0,%1,%2": "=r" (c) : "r" (b) , "i" (15)  );
res=c;b=~pattern[i];
asm volatile("pv.cmplt.sci.b %0,%1,%2": "=r" (c) : "r" (a) , "i" (0)  );
res=c;b=pattern[i];
asm volatile("pv.cmplt.sci.b %0,%1,%2": "=r" (c) : "r" (b) , "i" (15)  );
res=c;
b=~pattern[i];
...
res=c;b=~pattern[i];
asm volatile("pv.cmple.sci.h %0,%1,%2": "=r" (c) : "r" (a) , "i" (0)  );
res=c;b=pattern[i];
asm volatile("pv.cmple.sci.h %0,%1,%2": "=r" (c) : "r" (b) , "i" (15)  );
res=c;b=~pattern[i];
asm volatile("pv.cmple.sci.b %0,%1,%2": "=r" (c) : "r" (a) , "i" (0)  );
res=c;b=pattern[i];
asm volatile("pv.cmple.sci.b %0,%1,%2": "=r" (c) : "r" (b) , "i" (15)  );
res=c;
b=~pattern[i];
...
res=c;b=~pattern[i];
asm volatile("pv.cmpgtu.sci.h %0,%1,%2": "=r" (c) : "r" (a) , "i" (0)  );
res=c;b=pattern[i];
asm volatile("pv.cmpgtu.sci.h %0,%1,%2": "=r" (c) : "r" (b) , "i" (15)  );
res=c;b=~pattern[i];
asm volatile("pv.cmpgtu.sci.b %0,%1,%2": "=r" (c) : "r" (a) , "i" (0)  );
res=c;b=pattern[i];
asm volatile("pv.cmpgtu.sci.b %0,%1,%2": "=r" (c) : "r" (b) , "i" (15)  );
res=c;
b=~pattern[i];
...
res=c;b=~pattern[i];
asm volatile("pv.cmpgeu.sci.h %0,%1,%2": "=r" (c) : "r" (a) , "i" (0)  );
res=c;b=pattern[i];
asm volatile("pv.cmpgeu.sci.h %0,%1,%2": "=r" (c) : "r" (b) , "i" (15)  );
res=c;b=~pattern[i];
asm volatile("pv.cmpgeu.sci.b %0,%1,%2": "=r" (c) : "r" (a) , "i" (0)  );
res=c;b=pattern[i];
asm volatile("pv.cmpgeu.sci.b %0,%1,%2": "=r" (c) : "r" (b) , "i" (15)  );
res=c;
b=~pattern[i];
...
res=c;b=~pattern[i];
asm volatile("pv.cmpltu.sci.h %0,%1,%2": "=r" (c) : "r" (a) , "i" (0)  );
res=c;b=pattern[i];
asm volatile("pv.cmpltu.sci.h %0,%1,%2": "=r" (c) : "r" (b) , "i" (15)  );
res=c;b=~pattern[i];
asm volatile("pv.cmpltu.sci.b %0,%1,%2": "=r" (c) : "r" (a) , "i" (0)  );
res=c;b=pattern[i];
asm volatile("pv.cmpltu.sci.b %0,%1,%2": "=r" (c) : "r" (b) , "i" (15)  );
res=c;
b=~pattern[i];
...
res=c;b=~pattern[i];
asm volatile("pv.cmpleu.sci.h %0,%1,%2": "=r" (c) : "r" (a) , "i" (0)  );
res=c;b=pattern[i];
asm volatile("pv.cmpleu.sci.h %0,%1,%2": "=r" (c) : "r" (b) , "i" (15)  );
res=c;b=~pattern[i];
asm volatile("pv.cmpleu.sci.b %0,%1,%2": "=r" (c) : "r" (a) , "i" (0)  );
res=c;b=pattern[i];
asm volatile("pv.cmpleu.sci.b %0,%1,%2": "=r" (c) : "r" (b) , "i" (15)  );
res=c;
