...
int pattern[TEST_PATTERNS]= {0xbd4a28d,0x33eda22f,0x4e39cb17,0x511f12b3,0xcb5717e2,0x99529ac0,0x183739e,0x40d7f8f6,0x8470e424,0xf2840739,0x247c7e57,0x733c683e,0x24c65,0x6004bb1,0xe4f26c80,0x8dc98afa,0xc0a7efb,0xf070d9da,0x288fe6e6,0x1bac24dd,0x13c808a2, 0x13c808a2,0x181394a,0xb74165ef,0x716416e1,0x1dfa2527,0x200b91be,0x3abab995,0x1807a25,0x8fa53c5a,0x31943dde,0xe2003c3,0xcc0dd9f1,0x10444022,0x1a010b81,0x94628838,0x78106806,0xfffeffff,0x6bca9d83,0xffffffff,0x45aec28c,0x868f7fff,0x46f80011,0x9e48838,0x20710e5f,0x391cc208,0x5f32026,0x9e9d7d77
};
int pattern_a[TEST_PATTERNS]= {0xa3a29059,0x2930fde5,0x9436c124,0x2e39b80b,0x935f74e0,0x4144b9f7,0x9023dd3,0x10842424,0x5981f3b0,0x88100a25,0x640a0510,0xfdd08a2b,0x3f306889,0xecc8df7f,0x3e276ec,0x3210b02,0x6fd0859c,0x7ffc343c,0x5bf2640f,0x2b393524,0x84e85b93,0xaa7d3b3,0xb88fad77,0x9113bb35,0x932eabf0,0x7cfc987, 0x1ad5aeea,0x8a0000c5,0x4545d600,0x60e80020,0x4051b887,0x871f72b,0xc438ab9f,0x9a2e4144,0x99ff,0xd4084cb0,0xf02abd24,0xf8057e92,0x6624340d,0x52787c2d,0x63734672,0xb691a739,0x38e30dff,0x1c62025f, 0x8b063b9, 0x71a5c69e, 0x7af4a2a6, 0x711a3fcd, 0xd5fe519b, 0xc066d0a
};
volatile int a, b, c ;
volatile int res;
int i=0;
...
asm volatile ("c.mv %0,%1": "=r" (c): "r" (3));
res=c;
asm volatile ("c.add %0,%1": "=r" (c) : "r" (1));
res=c;
asm volatile ("c.sub %0,%1": "=r" (c) : "r" (5));
res=c;
asm volatile ("c.and %0,%1": "=r" (c) : "r" (2));
res=c;
asm volatile ("c.or %0,%1": "=r" (c) : "r" (3));
res=c;
asm volatile ("c.xor %0,%1": "=r" (c) : "r" (0));
res=c;

asm volatile ("c.slli %0,%1": "=r" (c) : "i" (2));
res=c;
asm volatile ("c.srai %0,%1": "=r" (c) : "i" (5));
res=c;
asm volatile ("c.srli %0,%1": "=r" (c) : "i" (7));
res=c;

asm volatile ("c.lw %0,%1":"+r"(c): "r" (c));
asm volatile ("c.li %0,%1": "=r" (c): "i" (10));
asm volatile ("c.sw %0,%1": "+r" (c): "r" (c));

asm volatile ("c.bneq %0,here_here\n\there_here:": :"r" (c));
